...
export default function FoodSupplyMonitor() {
  ...
  const daysRemaining = Math.floor(
    foodInventory / (dailyConsumption - dailyProduction)
  );
      ...
      <Card className='w-full max-w-lg bg-white-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-90 border border-gray-100'>
        <CardHeader className='border-b border-white/10'>
          ...
          <CardDescription
            ...
            Thermal treatment/ chemical leaching of soil, Controlled Environment
            Agriculture (CEA)
          </CardDescription>
        </CardHeader>
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  ...
                  <p className='text-2xl font-bold text-indigo-100'>
                    {foodInventory.toLocaleString()} kg
                  </p>
                ...
                <div>
                  ...
                  <div className='mt-2 text-xs text-indigo-100/80'>
                    <span className='font-medium'>Est. Supply Duration:</span>{' '}
                    {daysRemaining} days
                  </div>
                </div>
              </div>
            ...
            <div className='backdrop-blur-md p-4 rounded-lg border border-white/20'>
              ...
              <div className='space-y-3'>
                <div className='space-y-1'>
                  ...
                  <Progress
                    value={(foodWaste / dailyProduction) * 100}
                    className='h-1.5'
                  />
                </div>
                <div className='space-y-1'>
      ...
      <AlertDialog open={infoDialogOpen} onOpenChange={setInfoDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              <p className='mb-4'>
                This dashboard provides comprehensive monitoring of the Mars
                habitat food system, tracking inventory levels, nutritional
                balance, and production efficiency.
              </p>
              <p className='mb-4'>
                The food production cycle incorporates hydroponic and aeroponic
                farming technologies, utilizing specialized Mars-adapted crop
                varieties that maximize resource efficiency while maintaining
                nutritional quality.
              </p>
              <p>
                Regular monitoring of these metrics is essential for maintaining
                food security in the isolated Mars environment, where supply
                chains from Earth are limited by launch windows occurring only
                every 26 months.
              </p>
            </AlertDialogDescription>
          </AlertDialogHeader>
