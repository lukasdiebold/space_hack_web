...
export function Model(props: React.JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF(
    '/spacex_starship-with_landing_legs_deployed/scene.gltf'
  ) as unknown as GLTFResult;

  return (
    <group {...props} dispose={null} position={[10, 0, 0]} scale={1}>
      <mesh
        castShadow
        receiveShadow
      ...
      <mesh
        ...
        material={materials['Happy_Days_9043997e-52f1-4b23-80bd-41a5a8458bbd']}
      />
      <mesh
        castShadow
        receiveShadow
...
useGLTF.preload('/spacex_starship-with_landing_legs_deployed/scene.gltf');
